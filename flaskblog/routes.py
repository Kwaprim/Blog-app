...
def login():
    ...
    if form.validate_on_submit():
        ...
        # Querying database for user validation
...
def save_picture(form_picture):
    ...
    output_size = (125, 125)
    resized_form_picture = Image.open(form_picture)
    resized_form_picture.thumbnail(output_size)
    resized_form_picture.save(picture_path)
...
def update_post(post_id):
    ...
    return render_template("create_post.html", title = post.title, post = post, legend = 'Update Post', form = form)
